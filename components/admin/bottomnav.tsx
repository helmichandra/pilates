...
export default function BottomNav() {
  ...
  return (
    <>
      ...
      {/* lg:hidden memastikan navigasi bawah hanya muncul di HP & Tablet kecil */}
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-gray-100 z-50">
            ...
            return (
              <Link key={index} href={item.href} className="relative group">
                ...
                >
                  ...
                  {isActive && (
                    <motion.div layoutId="activeTab" className="absolute -bottom-2 w-1 h-1 bg-[#640D14] rounded-full" />
                  )}
                </motion.div>
              </Link>
            );
