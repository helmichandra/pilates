...
export default function CreditPackage({ credits, name, price, badge, promotion, onClick }: any) {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick} // TRIGGER FUNGSI UTAMA
      className="group w-full bg-white border-2 border-gray-100 rounded-[2rem] p-6 hover:border-[#640D14]/20 hover:shadow-xl hover:shadow-[#640D14]/5 transition-all text-left relative overflow-hidden cursor-pointer outline-none"
    >
      <div className="flex items-start justify-between gap-4 relative z-10">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            {badge && (
              <div className="bg-[#640D14] text-white text-[8px] font-black px-3 py-1 rounded-full flex items-center gap-1 uppercase tracking-widest">
