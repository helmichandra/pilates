  ...
  return (
    <div className="w-full">
      ...
      {transactions.length === 0 ? (
        <div className="bg-gray-50/50 rounded-[2rem] p-10 text-center border-2 border-dashed border-gray-100">
          <p className="text-gray-400 font-bold text-[10px] uppercase tracking-widest">No history found</p>
        </div>
      ) : (
