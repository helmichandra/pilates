...
export default function CreditCards({ reformerCount = 5, chairCount = 2, privateCount = 0 }) {
  const cardData = [
    { label: "Reformer", count: reformerCount, bg: "from-[#640D14] to-[#38040E]" },
    { label: "Chair", count: chairCount, bg: "from-[#800E13] to-[#640D14]" },
    { label: "Private", count: privateCount, bg: "from-[#2C3E50] to-[#000000]" }, // Private menggunakan Dark/Lux
  ];
  ...
  return (
    <div className="px-6 py-4 max-w-4xl mx-auto space-y-4">
      ...
      <motion.div whileHover={{ y: -5 }} transition={{ type: "spring", stiffness: 300 }}>
        <Card className={`bg-gradient-to-br ${cardData[2].bg} text-white p-8 rounded-[2.5rem] relative overflow-hidden border-none shadow-2xl shadow-black/10`}>
